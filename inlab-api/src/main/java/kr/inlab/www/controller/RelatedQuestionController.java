...
public class RelatedQuestionController {
	...
	// public ResponseEntity<ResponseListDto<ResponseRelatedQuestionsDto>> getRelatedQuestions(@PathVariable Long questionId) {
	// 	ResponseListDto<ResponseRelatedQuestionsDto> responseDto = relatedQuestionService.getRelatedQuestions();
