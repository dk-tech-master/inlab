...
public interface QuestionVersionRepository extends JpaRepository<QuestionVersion, Long> {
	...
	@Query("SELECT new kr.inlab.www.dto.response.ResponseQuestionVersionsDto(qv.title, p.positionId, p.positionName, qt.questionTypeId, qt.questionTypeName, ql.questionLevelId, ql.questionLevelName, qv.version) " +
		"FROM QuestionVersion qv " +
		"JOIN qv.question q " +
		"JOIN q.position p " +
		"JOIN q.questionType qt " +
