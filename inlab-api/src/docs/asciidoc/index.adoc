...
include::{snippets}/update-user-role/response-headers.adoc[]
...
== CHECKLIST RESULT CONTROLLER

=== 체크리스트 결과 수정 / PATCH
체크리스트 결과 수정에 대한 API 입니다.

==== 요청 URL

include::{snippets}/update-checklist-result/http-request.adoc[]

==== Path Variables

include::{snippets}/update-checklist-result/path-parameters.adoc[]

==== Headers

include::{snippets}/update-checklist-result/request-headers.adoc[]

==== 요청 Body

include::{snippets}/update-checklist-result/request-fields.adoc[]

==== 응답 Body

include::{snippets}/update-checklist-result/http-response.adoc[]

---

== USER QUESTION HISTORY CONTROLLER
...
== INTERVIEW QUESTION RESULT CONTROLLER
